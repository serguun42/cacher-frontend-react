...
export default function PopupAboutSchedule() {
  ...
  const popupPayload = {
    title: 'О версиях',
    messages: [
      `Кроулер кэшера всегда сохраняет три версии постов: изначальную – при публикации
      ...
      – в них, например, нет аватарок пользователей, ссылок и донатов, используется другой 
      формат медиа-вложений.`,
