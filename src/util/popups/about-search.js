...
export default function PopupAboutSearch() {
  ...
  const popupPayload = {
    ...
    messages: [
      ...
      <span key="about-search-4">
        Вы можете задать в поиске ссылку на пост вместе с комментарием (<i>dtf.ru/666655?comment=9679958</i>) – после
        загрузки результатов, вы сможете перейти непосредственно к комментарию с указанным ID. Прямо как на настоящей
        Основе! 🎉
      </span>,
    ],
    isBig: true,
